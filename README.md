...
The Medicare BCDA Connector is a dbt package that maps Medicare BCDA claims data to the Tuva [claims data model](https://thetuvaproject.com/connectors/input-layer) which then makes it simple to run the entire [Tuva Project](https://github.com/tuva-health/the_tuva_project).
<br/><br/>  
